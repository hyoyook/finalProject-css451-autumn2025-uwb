...
public class LightControl : MonoBehaviour
{
    ...
    public Vector3 FollowOffset = new Vector3(0, 2, -0.2f); 
    ...
    public float SpotlightRadius = 1.0f; 
    
    private float DayMaxTheta = 1.0f;    
    ...
    [SerializeField] private float currentIntensity = 2.0f;
    ...
    private void dirLightFollowCamera() {
        ...
        // Sets a fixed "Sun" angle shining from high up (50 degrees)
        DirectionalLight.rotation = Quaternion.Euler(50, -30, 0);
        
        Shader.SetGlobalFloat("_MaxTheta", DayMaxTheta); 
        Shader.SetGlobalFloat("_MinTheta", 0.0f);
        
        // Simulates Sun being very far away
        Shader.SetGlobalVector("LightDirection", -DirectionalLight.forward);
        Shader.SetGlobalVector("SlightPos", DirectionalLight.position + (-DirectionalLight.forward * 500));
    }
